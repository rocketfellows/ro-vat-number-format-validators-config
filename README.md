# Romania vat number format validators config

![Code Coverage Badge](./badge.svg)

This package provides a preconfigured configuration class for vat number format validators for Romania country.
Is an extension of the package https://github.com/rocketfellows/specific-country-vat-number-format-validators-config.

## Installation

```shell
composer require rocketfellows/ro-vat-number-format-validators-config
```

## Dependencies

- https://github.com/rocketfellows/specific-country-vat-number-format-validators-config v1.0.0;
- https://github.com/rocketfellows/ro-vat-format-validator v1.0.0;
...
- **_rocketfellows\ROVatNumberFormatValidatorsConfig\ROVatNumberFormatValidatorsConfig_** - preconfigured configuration class for vat number format validators for Romania country;

## ROVatNumberFormatValidatorsConfig description

A configuration class that provides a match for the vat number format validators for the country Romania.

Class interface:
- **_getCountry_** - returns Romania **_Country_** instance;
- **_getValidators_** - returns validators tuple

When initializing the default configuration, the **_getValidators_** function returns a tuple with a single validator - an instance of ROVatFormatValidator.

```php
$config = new ROVatNumberFormatValidatorsConfig();

$config->getCountry();      // returns Romania Country instance
$config->getValidators();   // returns CountryVatFormatValidators with one item - instance of ROVatFormatValidator
```
...
$config = new ROVatNumberFormatValidatorsConfig($newDefaultValidator);  // initialize with new default validator
...
// default preconfigured validator by default - instance of ROVatFormatValidator
